#' model bacteria generation from gulls
#'
#' This function is the bacteria source-model gulls The model
...
wildlife.Gulls <- function(chr.file.input) {
...
## animal information
  ...
  ## all landuse has stream access for gullss
