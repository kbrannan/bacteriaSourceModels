#'  model bacteria generation from racoons
#'
#'  This function is the bacteria source-model Racoon. The model
...
wildlife.Racoon <- function(chr.file.input) {
...
## animal information
  ...
  ## all landuse has stream access for Racoon
